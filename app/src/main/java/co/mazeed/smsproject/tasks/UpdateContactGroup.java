...
public class UpdateContactGroup   extends Task {
	...
	public UpdateContactGroup(DataRequestor requestor, Context context, HashMap<String, String>inputs) {
		setRequestor(requestor);
		setId(TaskID.UpdateContactGroupTask);
		this.mxontext = context;
		url = Communication.Common_Base_URL + "updateContactGroup/?";
