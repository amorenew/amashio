...
public class ResetPassword  extends Task {
	...
	public ResetPassword(DataRequestor requestor, Context context, HashMap<String, String>inputs) {
		setRequestor(requestor);
		setId(TaskID.ResetPasswordTask);
		this.mxontext = context;
		url = Communication.Common_Base_URL + "resetPassword/?";
