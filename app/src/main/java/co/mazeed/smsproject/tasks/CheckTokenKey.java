...
public class CheckTokenKey extends Task {
	...
	public CheckTokenKey(DataRequestor requestor, Context context, HashMap<String, String>inputs) {
		setRequestor(requestor);
		setId(TaskID.CheckTokenKeyTask);
		this.mxontext = context;
		url = Communication.Common_Base_URL + "checkTokenkey/";
