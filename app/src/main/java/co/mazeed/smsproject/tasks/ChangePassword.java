...
public class ChangePassword  extends Task {
	...
	public ChangePassword(DataRequestor requestor, Context context, HashMap<String, String>inputs) {
		setRequestor(requestor);
		setId(TaskID.UpdatePasswordTask);
		this.mxontext = context;
		url = Communication.Common_Base_URL + "updatePassword/";
