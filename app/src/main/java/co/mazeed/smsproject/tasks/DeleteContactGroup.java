...
public class DeleteContactGroup    extends Task {
	...
	public DeleteContactGroup(DataRequestor requestor, Context context, HashMap<String, String>inputs) {
		setRequestor(requestor);
		setId(TaskID.DeleteContactGroupTask);
		this.mxontext = context;
		url = Communication.Common_Base_URL + "delContactGroup/";
